...
Meta programming is achieved by code generation which makes programs fast and stable at runtime. The main goal is to ensure that the compiled metacode is the working code. In the other hand, `Jeta` was designed to provide generated code that works fast.
