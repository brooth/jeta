Jeta
====
`Jeta` - is an Open Source library built on `javax.annotation.processing` that brings meta programming in a Java project. `Jeta` aims to reduce boilerplate and increase error detection at compile-time.
